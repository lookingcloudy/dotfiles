...
* Most settings will now be updated silently in the background and not require a manual reload. Some special settings require a reload, in which case
  the user is prompted for it. (as discussed in Issue [#132](https://github.com/Josee9988/MinifyAll/issues/132))
...
* Issue [#125](https://github.com/Josee9988/MinifyAll/issues/125) (PHP context menu will only show to minify the selected text)
...
* Removed disabled file types if the user has selected the option to minify on save to fix issue [#86](https://github.com/Josee9988/MinifyAll/issues/86)
...
* Specific activation events to improve the VS Code startup time (MinifyAll will only be initialized when the user opens any of the supported file types). Close issue [#72](https://github.com/Josee9988/MinifyAll/issues/72)
...
* Updated "terser" to its latest version to close [#65](https://github.com/Josee9988/MinifyAll/issues/65).
...
* Fixed issue [#52](https://github.com/Josee9988/MinifyAll/issues/52). Command MinifyAll2OtherDoc seems to be working in windows and linux.
...
* Right click minify on the explorer working for JavaScript and JSX to close [#48](https://github.com/Josee9988/MinifyAll/issues/48).
...
* Fixed problem with CSS minification, issue [#20](https://github.com/Josee9988/MinifyAll/issues/20).
...
* Issue [#16](https://github.com/Josee9988/MinifyAll/issues/16). HTML removed spaces on line endings causing to join two words into one, the regex was improved and commented in some regex instructions.
