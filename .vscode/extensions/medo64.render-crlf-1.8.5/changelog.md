...
### Fixed
- Partially fixed rendering for extra whitespace [issue [#27](https://github.com/medo64/render-crlf/issues/27)](https://github.com/medo64/Render-CRLF/issues/27); rendering is different than default
- Security updates for dependencies
